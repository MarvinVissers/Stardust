<?php
	...
	{
        $loginEmail = htmlentities($_POST['txtEmail']);
        $loginPassword = htmlentities($_POST['txtPassword']);
    
		$result = $logintje->loginUser($loginEmail, $loginPassword);
	}
?>

<html>
    <head>
       <title>Gign-in Stardust Hotel</title>
    ...
    <body>
                        ...
                        <div class="align-right">
                            ...
                            <?php 
                                if (isset($_SESSION['email'])){
                                    ...
                                    echo "<li class='ative align-right'><a class='active'  href='sign-in.php'>Sign in</a></li>";
                                }
                            ?>
                        </div>
                    </ul>
                ...
                <div class="intro">
                    <div class="intro-blok">
                        <div class="intro-tekst">
                            <H1 class="intro-tekst-header">Sign-in</h1>
                            <h3>This is the incredable page where you can sign-in to your Stardsut account. With that you can make a reservation</h3>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <form id="InlogForm" method="POST" enctype="multipart/form-data" onsubmit="return validateInlogFormUser()">
                        <h2>Sign-in</h2>
                        <label>E-mail</label>
                        ...
                        <div class="from-group">
                            <input type="submit" id="InlogUser" name="Log-inClient" value="Sign-in" class="btn btn-primary btn-lg" required/>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-sm-6">
                    <h3>No account?</h3>
                    <p>
                        No account yet, what are you waiting for and create your account right now by clicking  the button below. 
                    </p>
                    <a class="btn btn-primary" href="sign-up.php">Make an account &raquo;</a>
                </div>
            </div>
        </div>
