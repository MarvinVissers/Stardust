<?php
    ...
    $room = new kamer("localhost", "root", "", "stardust");
?>

<html>
    <head>
        <title>Rooms - Stardust Hotel</title>
        ...
        <div class="content">
            <section>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2 style="text-align:center;">Choose a room to view the details</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <?php
                            $listRooms = $room->getOverviewroom();

                            foreach($listRooms as $kamer){
                                $kamer->getKid();
                        ?>
                            <div class="col-md-4" style="padding-bottom: 30px;">
                                <div class="card">
                                    <img class="card-img-top" src="images/<?php echo $kamer->kid.$kamer->picture;?>" alt="<?php echo $kamer->room_name;?>"/>
                                    <div class="card-body">
                                        <h4 class="card-title"><?php echo $kamer->room_name; ?></h4>
                                        <p class="card-text"><?php echo $kamer->description; ?></p>
                                    </div>
                                    
                                    <div class="card-footer">
                                        <a href="<?php echo 'roomdetails.php?kid='.$kamer->kid; ?>" class="btn btn-primary">Find Out More!</a>
                                    </div>
                                </div>
                            </div>
                        <?php
